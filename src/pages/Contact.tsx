          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Whether you have a question, need a quote, or want to discuss your project, we're here to help. Reach out through any of the channels below.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Pretoria & Centurion, Gauteng</p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C05A1E] focus:border-transparent outline-none transition-all resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-[#C05A1E] hover:bg-[#A04A18] text-white py-4 rounded-lg font-semibold transition-colors"
                >
                  Send Via WhatsApp
                </button>
              </form>
